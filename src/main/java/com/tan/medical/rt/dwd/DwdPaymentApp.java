...
public class DwdPaymentApp {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("CREATE TABLE IF NOT EXISTS dwd_payment (\n" +
                "  `id` STRING NOT NULL,\n" +
                "  `create_time` TIMESTAMP(6) COMMENT '创建时间',\n" +
                "  `update_time` TIMESTAMP(6) COMMENT '修改时间',\n" +
                "  `payment_amount` decimal(19,2) COMMENT '支付金额',\n" +
                "  `status` SMALLINT COMMENT '支付状态：202.未支付 203.已支付',\n" +
        ...
        tableEnv.executeSql("INSERT INTO dwd_payment\n" +
                "SELECT\n" +
