...
public class DwdReviewApp {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("CREATE TABLE IF NOT EXISTS dwd_review\n" +
                "(\n" +
        ...
        tableEnv.executeSql("INSERT INTO dwd_review\n" +
                "SELECT\n" +
                ...
                "FROM ods_consultation where status = 207;");
